...
const Section1: FC<Section1Props> = ( {ImgSec, head, par, btn_line } ) => {
    ...
    return (
        <Container fluid className='cs-bg-image py-5'>
            <Row className='my-5 pt-5'>
                <Col xs={12} lg={5} className='d-flex flex-column justify-content-center align-items-center text-center text-lg-start align-items-lg-start px-5'>
                ...
                <Col xs={12} lg={7} className='pt-5 px-5'>
